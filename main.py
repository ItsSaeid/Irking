    ...
    select = Select(placeholder="رنک مورد نظرت رو انتخاب کن...",
                    options=[
                        discord.SelectOption(
                            ...
                            value="legendary",
                            emoji="🏅",
                            description="ماه | هفته | 360 تومان | 100 تومان"),
                        discord.SelectOption(
                            label="Elite Commander",
                            value="elite",
                            emoji="💠",
                            description="ماه | هفته | 480 تومان | 120 تومان"),
                        discord.SelectOption(
                            label="GameMaster",
                            value="gamemaster",
                            emoji="👑",
                            description="ماه | هفته | 640 توم 155 تومان"),
                        discord.SelectOption(
                            label="Overlord",
                            value="overlord",
                            emoji="💎",
                            description="ماه | هفته | 800 تومان |  200 تومان"),
                    ])
